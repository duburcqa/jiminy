...
from ray.rllib.utils.typing import EnvCreator, PolicyID
...
def build_eval_policy_from_checkpoint(checkpoint_path: str) -> Tuple[
    ...
    for pid, policy_state in policy_states.items():
        ...
        if preprocessing_enabled:
            ...
            if not merged_conf.enable_connectors:
                preprocessors[pid] = preprocessor
    ...
    return policy_map, filters, preprocessors
