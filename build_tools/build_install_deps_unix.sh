...
#   Boost >= 1.78 is causing segfault if combined when dlopen RTLD_GLOBAL bit is set, which
#   is essential for interoperability of Boost.Python modules based on different version.
