...
${SUDO_CMD} python3 -m pip install --upgrade "pip<23.1" && \
${SUDO_CMD} python3 -m pip install --upgrade "setuptools<66.0" "wheel<0.40" && \
${SUDO_CMD} python3 -m pip install --upgrade "numpy>=1.16" numba
