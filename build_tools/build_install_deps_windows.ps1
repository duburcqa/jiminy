...
{
  $RootDir = (Get-Location).Parent.FullName
}
...
Out-File -Encoding ASCII "$RootDir\boost_1_${Env:BOOST_MINOR_VERSION}_0\libs\python\include\boost\python\operators.hpp"
Set-PSDebug -Trace 1
