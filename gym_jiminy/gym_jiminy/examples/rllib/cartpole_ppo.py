...
if AGENT_ALGORITHM == "ppo" or AGENT_ALGORITHM == "appo":
    ...
    agent_cfg["vf_loss_coeff"] = 1.0e-2         # Coefficient of the value function loss
    ...
    agent_cfg["grad_clip"] = float("inf")       # Clip the global norm of gradients by this amount (None = disable)
...
t_end = 0.0 # Total duration of the simulation(s) in seconds
