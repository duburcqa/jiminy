...
namespace jiminy
{
    ...
    EngineMultiRobot::~EngineMultiRobot(void) = default;
    ...
    const forceCouplingRegister_t & EngineMultiRobot::getForcesCoupling(void) const
    {
    ...
    const stepperState_t & EngineMultiRobot::getStepperState(void) const
    {
        return stepperState_;
    }

    const bool_t & EngineMultiRobot::getIsSimulationRunning(void) const
    {
