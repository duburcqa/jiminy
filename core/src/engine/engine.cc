...
namespace jiminy
{
    ...
    const forceImpulseRegister_t & Engine::getForcesImpulse(void) const
    {
    ...
    const forceProfileRegister_t & Engine::getForcesProfile(void) const
    {
    ...
    const bool_t & Engine::getIsInitialized(void) const
    {
