...
namespace jiminy
{
    ...
    public:
        ...
        const forceCouplingRegister_t & getForcesCoupling(void) const;
        ...
        const stepperState_t & getStepperState(void) const;
        const bool_t & getIsSimulationRunning(void) const;
